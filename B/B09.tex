...
Comme montré sur la sous figure 1 de la \autoref{fig:B09-1}, il s'agit très souvent d'un rétro direct tout à fait normal. Nous aurons le soin de ne pas jouer trop loin du
...
\noindent Remarques :
\begin{itemize}
	\item Si le rétro est un peu long, il faudra plus d'allonge, on jouera plus
bas et plus souplement.
\item Si le rétro est court, relevez un peu la flèche vers le centre bille
...
\item Si la 3 est proche de la petite bande et un peu écartée du coin, un deux
...
Sous figure 2 de la \autoref{fig:B09-1} : L'angle formé par la direction 1-2 et la grande bande proche
